...
(function() {
    ...
    j.sample = function(n, t, r) {
        return null == t || r ? (n.length !== +n.length && (n = j.values(n)),
        n[j.random(n.length - 1)]) : j.shuffle(n).slice(0, Math.max(0, t))
    }
    ;
    var E = function(n) {
    ...
    j.sortBy = function(n, t, r) {
        return t = E(t),
        j.pluck(j.map(n, function(n, e, u) {
            return {
                value: n,
                index: e,
    ...
    j.throttle = function(n, t, r) {
        ...
        return function() {
            ...
            o = l,
            i = n.apply(e, u),
            e = u = null) : a || r.trailing === !1 || (a = setTimeout(c, f)),
            i
        }
    }
    ,
